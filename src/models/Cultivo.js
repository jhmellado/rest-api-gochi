...
const cultivoSchema = new Schema(
  {
    ...
    cul_info_nutricional_go: {
      cul_beneficios_go: String,
      cul_cantidad_go: String,
      cul_calorias_go: String,
      cul_grasas_totales_go: String,
      cul_colesterol_go: String,
      cul_sodio_go: String,
      cul_potasio_go: String,
      cul_carbohidratos_go: String,
      cul_azucares_go: String,
      cul_proteinas_go: String,
      cul_vitmin_go: [Schema.Types.Mixed],
    },
